...
// Inlined directly from https://raw.githubusercontent.com/mgladdish/scala-mustache/osgi/src/main/scala/Mustache.scala
// as package not deployed outside bintray
